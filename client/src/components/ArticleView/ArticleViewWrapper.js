...
function ArticleViewWrapper() {
  ...
  // useEffect(async () => {
  // setContribution(contributions); //axios연결시 지우기
                ...
                <div className="header">
                  <div className="headerleft">
                    <div className="keyword">
                      {contributions.contribution_keyword}
                    </div>
                    <div className="title">
                      {contributions.contribution_title}
                    </div>
                  </div>
                  <svg
                    className="hamburger"
                  ...
                  <div className="datawrapper">
                    ...
                    조회 <span className="data">{contributions.hit}</span>
                  </div>
                </div>
                <div className="body">
                  <div className="contents">
                    {contributions.contribution_content.slice(0, 200) + '...'}
                  </div>
